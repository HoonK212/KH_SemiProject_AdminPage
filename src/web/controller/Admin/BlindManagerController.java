...
/**
 * Servlet implementation class BlindManagerController
 */
@WebServlet("/web/main/blind")
public class BlindManagerController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private FranMenuService franmenuService = new FranMenuServiceImpl();
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Map<Fran,Menu> map = franmenuService.FranBlindSelect();
