...
@WebServlet("/measure/update")
public class ReportMeasureUpdateController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/WEB-INF/views/report/report_measure_edit.jsp")
		.forward(req, resp);
